...
namespace app.Shared.Proxy.Models;
...
public record ForwardedHeadersConfig
{
    ...
    /// <summary>
    ///     Gets or sets the header used to store the original value of the Host header field before applying forwarded
    ///     headers.
    ...
    /// </summary>
    public IList<IPAddress> KnownProxies { get; } = [IPAddress.IPv6Loopback];

    /// <summary>
    ///     Address ranges of known proxies to accept forwarded headers from.
    /// </summary>
    public IList<IPNetwork> KnownNetworks { get; } = [new(IPAddress.Loopback, 8)];

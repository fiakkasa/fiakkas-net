...
public class TechnologyCategoryBatchDataLoaderTests
{
    [Fact]
    public async Task LoadAsync_Should_Return_Data_When_Matches_Found_When_Kind_Is_SoftwareDevelopment()
    {
        ...
        var sut = new TechnologyCategoryBatchDataLoader(dataRepository, AutoBatchScheduler.Default);
    ...
    [Fact]
    public async Task LoadAsync_Should_Return_Data_When_Matches_Found_When_Kind_Is_InformationTechnology()
    {
        var dataRepository = new MockDataRepository<ICategory>(
        [
            new CategoryEntity
